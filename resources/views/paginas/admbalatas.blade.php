    ...
    <x-app-layout>
        ...
        <div class="py-4">
            ...
            <div style="text-align: center;">
                <a href="{{ route('balatas.create') }}" class="btn-primary">
                ...
                @forelse ($registro as $dato)
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('balatas.edit', $dato->id) }}" class="btn btn-primary">Editar</a>
                            <form action="{{ route('balatas.delete', $dato->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
