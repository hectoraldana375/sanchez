...
<div class="container mx-auto p-4">
    ...
    <div class="flex justify-center items-center relative mb-8">
        <h1 class="text-4xl font-bold text-gray-900 text-center">Reaparaciones Clutch</h1>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($productos as $producto)
            <div class="bg-white p-4 rounded-lg shadow-md relative">
                ...
                <p class="text-lg font-bold text-center absolute bottom-4 left-0 right-0">{{ number_format($producto->precio, 2) }}</p>
            </div>
        @endforeach
    </div>
</div>
